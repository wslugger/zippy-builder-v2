...
- For 'Design Options', if the options have a "category" field provided in the JSON, you MUST group them under Level 5 headers representing that category name (e.g., ##### Topology). For items within these subsections, use bold text ONLY for the option names (e.g., **Hub and Spoke (Standard)**) and plain text for their corresponding descriptions.

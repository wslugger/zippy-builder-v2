            ...
            <div className="space-y-12">
                ...
                <section>
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        <h2 className="text-xs font-bold text-zinc-400 uppercase tracking-widest px-4">Catalog</h2>
                        <div className="h-px flex-1 bg-zinc-200 dark:bg-zinc-800"></div>
                    </div>
                ...
                <section>
                    <div className="flex items-center gap-2 mb-6">
                        <div className="h-px flex-1 bg-zinc-200 dark:bg-zinc-800"></div>
                        <h2 className="text-xs font-bold text-zinc-400 uppercase tracking-widest px-4">Settings & Data</h2>
                        <div className="h-px flex-1 bg-zinc-200 dark:bg-zinc-800"></div>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <HubCard
                        ...
                        <HubCard
                            title="Settings Hub"
                            description="Configure system defaults, taxonomy bindings, and variables."
                            href="/admin/settings"
                            color="blue"
                        ...
                        <HubCard
                            title="AI Prompts"
                            description="Monitor and customize the system instructions and parameters for the AI-powered SA steps."

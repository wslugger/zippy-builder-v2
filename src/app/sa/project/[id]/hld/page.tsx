            ...
            <div className="bg-white dark:bg-white text-black shadow-2xl rounded-sm min-h-screen p-12 print:shadow-none print:m-0">
                {!isEditing ? (
                    ...
                    <div className="h-full flex flex-col">
                        ...
                        <textarea
                            className="flex-1 w-full min-h-[650px] p-6 font-mono text-sm border border-neutral-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none bg-neutral-50 shadow-inner"
                            value={markdown}
